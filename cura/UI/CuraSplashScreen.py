...
class CuraSplashScreen(QSplashScreen):
    ...
    def drawContents(self, painter):
        ...
        painter.drawText(260, 70 + self._version_y_offset, round(330 * self._scale), round(230 * self._scale), Qt.AlignLeft | Qt.AlignTop, version[0])
        if len(version) > 1:
        ...
        painter.setPen(pen)
        painter.drawArc(60, 250, round(32 * self._scale), round(32 * self._scale), round(self._loading_image_rotation_angle * 16), 300 * 16)
        ...
        if self._current_message:
            ...
            painter.setPen(pen)
            painter.setFont(font)
            painter.drawText(100, 228, 170, 64,
