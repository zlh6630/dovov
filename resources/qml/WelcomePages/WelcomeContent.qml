...
Item
{
    UM.I18nCatalog { id: catalog; name: "DOVOV" }
    ...
    Column
    {
        ...
        Label
        {
            ...
            text: catalog.i18nc("@label", "Welcome to DOVOV Slicer")
        ...
        Label
        {
            ...
            text: catalog.i18nc("@text", "Please follow these steps to set up  DOVOV Slicer. This will only take a few moments.")
            wrapMode: Text.Wrap
